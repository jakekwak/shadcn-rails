...
#[component]
pub fn Casestudy8() -> Element {
    rsx! {
        section {
            class: "py-32",
            div {
                class: "container flex flex-col gap-12 lg:flex-row lg:gap-24",
                article {
                    class: "mx-auto",
                    img {class: "mb-8 aspect-video w-full max-w-3xl rounded-lg border object-cover", src: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-1.svg", alt: "placeholder"}
                    div {
                        class: "prose",
                        h1 { "How Mercury uses shadcn/ui to build their design system" }
                ...
                aside {
                    ...
                    div {
                        class: "border-border bg-accent flex flex-col items-start rounded-lg border py-6 md:py-8",
                        div {
                            class: "mb-8 px-6",
                            img {class: "max-h-8 w-auto", src: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/supabase-wordmark.svg", alt: "Supabase"}
                        }
                        div {
                            class: "mb-5 px-6 last:mb-0",
                        ...
                        div {
                            class: "border-border mb-5 w-full border-t px-6 pt-5 last:mb-0",
                            div {class: "mb-2 text-xs font-semibold",
                                "Location"}
                            div {class: "text-muted-foreground overflow-hidden text-xs md:text-sm",
                        ...
                        div {
                            ...
                            div {class: "mb-2 text-xs font-semibold",
                                "Website"}
                            div {
                                class: "text-muted-foreground overflow-hidden text-xs md:text-sm",
                                a {class: "hover:text-foreground underline", href: "https://example.com",
                                    "https://example.com/"}
                            }
                        }
                        div {
